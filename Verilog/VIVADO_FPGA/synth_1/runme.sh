...
HD_PWD='C:/Users/Asus/Course_Project/Course_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4bit_PTL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_4bit_PTL.tcl
