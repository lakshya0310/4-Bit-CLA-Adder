...
HD_PWD='C:/Users/Asus/Course_Project/Course_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4bit_PTL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLA_4bit_PTL.tcl -notrace
